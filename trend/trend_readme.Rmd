...
The columns `trend_lg` represents the p-value of the t-test that verifies if the slope of a linear trend is different from zero.
...
Trends in the frequency of the peaks (`trend_lg`) appear to be the most common cause of nonstationarity and are more frequent in the Prairies and Southern Ontario 
...
trend <- read.csv(gzfile('trend.csv.gz'))
